...
<html lang="en">
  <head>
    ...
    <title>Team VoN :: Achievments</title>
    ...
    <!-- Main Container -->
      <div id="main-container">
                ...
                <!-- Header Menu EN -->
                  <div class="col-xs-12 col-md-7 header-menu" id="navigation">
                    <ul class="header-menu-list list-inline">
                      ...
                      <li class="current-item"><a href="http://192.168.0.104/vongg/achievments">Achievments</a></li>
                ...
                <!-- Header Menu PL -->
                  <div class="col-xs-12 col-md-7 header-menu" id="navigation">
                    <ul class="header-menu-list list-inline">
                      ...
                      <li class="current-item"><a href="http://192.168.0.104/vongg/achievments">Osiągnięcia</a></li>
        ...
        <!-- Achievments Section -->
          <div class="container-fluid">
            <div class="row">
              <div class="col-xs-12 achievments-section">
                <!-- Heading Section -->
                <div class="col-xs-12 col-md-11 col-md-offset-1 heading-section">
                  <h1>Achievments</h1>
                </div>
                <!-- / Heading Section -->
                <div class="col-xs-12 col-md-8 col-md-offset-2 achievments-items">
                  <div class="col-xs-12 col-md-6 achievments-list">
                    <h1>Online</h1>
                    <ul>
                      <li><span class="first-place"><i class="fa fa-trophy"></i><span class="strong-place">1st place on</span> ESEA MDL League Season 30</span></li>
                    </ul>
                  </div>
                  <div class="col-xs-12 col-md-6 achievments-list">
                    <h1>Offline</h1>
                    <ul>
                      <li><span class="first-place"><i class="fa fa-trophy"></i><span class="strong-place">1st place on</span> IEM Katowice 2018</span></li>
                    </ul>
                  </div>
                </div>
              </div>
